...
Подробности: [portfolio case study](docs/PORTFOLIO_CASE_STUDY.md) и
[план рассказа на собеседовании](docs/INTERVIEW_TALK_TRACK.md).

## Для резюме

> Разработал с нуля внутреннюю Django-систему учёта автомобильных и
> железнодорожных отгрузок, заменив общий Excel-файл многопользовательским
> веб-интерфейсом. Реализовал RBAC, импорт/экспорт XLSX, аудит, файловые
> документы, Docker-деплой и backup/restore; использовал Claude Code и OpenAI
> Codex в AI-assisted цикле разработки.
