...
Веб-система учёта автомобильных и железнодорожных отгрузок.

Публичный репозиторий содержит согласованную заказчиком демонстрационную версию, подготовленную на основе одного из предыдущих релизов закрытого коммерческого продукта. Актуальная версия продукта внедрена и эксплуатируется на инфраструктуре заказчика.

Демонстрационная версия использует только синтетические данные и не содержит исходный код актуальной коммерческой версии, реальные данные, документы или внутреннюю информацию заказчика.
